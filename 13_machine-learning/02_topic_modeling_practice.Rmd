...
inaug_words <- inaug %>%
  ...
  dplyr::count(President, word, sort = TRUE)
...
# merge
inaug_words <- dplyr::left_join(inaug_words, inaug_total_words)

# plot
ggplot2::ggplot(inaug_words, aes(x = n/total, fill = President)) +
