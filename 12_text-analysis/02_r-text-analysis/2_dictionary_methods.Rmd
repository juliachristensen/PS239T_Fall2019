...
# load data on presidential inaguration speeches 
...
inaug %>%
  ...
  count(President, Year, value) %>%
  ggplot(aes(x = value, y = n, col)) +
...
race_dictionary <- data.frame(word = c("african", "negro", "black", "asian", "oriental", "latino", "hispanic", "nonwhite"), category = c("African Americans", "African Americans", "African Americans", "Asian Americans", "Asian Americans", "Latinx", "Latinx", "People of Color"))
